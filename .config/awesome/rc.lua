...
--end
-- }}}
gears.wallpaper.fit(beautiful.wallpaper1, 2)
gears.wallpaper.fit(beautiful.wallpaper2, 1)
...
globalkeys = awful.util.table.join(
    ...
    -- My shortcut program
    awful.key({ modkey            }, "v"     , function () awful.util.spawn("remote-viewer spice://hp:5930") end),
    awful.key({ modkey, "Shift","Control"}, "p"     , function () awful.util.spawn("sudo poweroff") end),
    awful.key({ modkey            }, "s"     , function () awful.util.spawn("sudo systemctl suspend") end),
...
client.connect_signal("manage", function (c, startup)
    ...
    if titlebars_enabled and (c.type == "normal" or c.type == "dialog") then
        ...
        -- use MOD-S-t to toggle, see client keys
